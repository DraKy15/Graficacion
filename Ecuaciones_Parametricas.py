...
img = np.ones((height, width, 2), dtype=np.uint8)*255

# Parámetros de la figura paramétrica
a, b = 101, 199  # Reducir los valores de a y b para que la curva se ajuste mejor
k = 1.2# Constante de multiplicación del ángulo
theta_increment = 0.05  # Incremento del ángulo
max_theta = 2 * np.pi  # Un ciclo completo
